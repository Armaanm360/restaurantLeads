...
class CRMLeadModel extends schema_1.default {
    ...
    getSingleLead(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("lead_view as lv")
                .withSchema(this.CRM_SCHEMA)
                .select("*")
                .where("lv.id", id);
        });
    ...
    getAllLeadTracking(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield dtbs
                .select("id", "lead_id", "org_id", "lead_org_id", "lead_org_name", "meeting_id", "follow_up_date", "title", "action_type", "sale_amount", "paid_amount", "due_amount", "description", "tracking_type", "remarks", "payment_collection_date", "admin_name", "emp_name", "created_at", "call_note", "emp_id", "forward_note", "emp_id", "emp_name", "admin_id", "admin_name")
                .withSchema(this.CRM_SCHEMA)
                .where({ org_id })
                .andWhere({ lead_id })
                .andWhere(function () {
