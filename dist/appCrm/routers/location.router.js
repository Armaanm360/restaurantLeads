...
const location_controller_1 = __importDefault(require("../controller/location.controller"));
const location_validation_1 = __importDefault(require("../utils/validation/setting/location.validation"));
// location routes
class CRMLocationRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.controller = new location_controller_1.default();
...
exports.default = CRMLocationRouter;
