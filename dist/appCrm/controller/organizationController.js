...
class CrmOrganizationController extends abstract_controller_1.default {
    constructor() {
        super();
        ...
        // Get all leads organization name
        this.getAllLeadsByOrganizationName = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _g = yield this.OrganizationService.getAllLeadsByOrganizationName(req), { code } = _g, data = __rest(_g, ["code"]);
            res.status(code).json(data);
        }));
    }
}
exports.default = CrmOrganizationController;
