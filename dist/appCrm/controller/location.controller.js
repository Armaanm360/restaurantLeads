...
const location_service_1 = __importDefault(require("../service/location.service"));
const location_validation_1 = __importDefault(require("../utils/validation/setting/location.validation"));
class CrmLocationController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new location_service_1.default();
...
exports.default = CrmLocationController;
