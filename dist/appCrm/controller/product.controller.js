...
class CRMProductController extends abstract_controller_1.default {
    constructor() {
        super();
        this.ProductService = new product_service_1.default();
        this.validator = new product_validator_1.default();
        // create product controller
        this.createProduct = this.asyncWrapper.wrap({ bodySchema: this.validator.createProductValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.ProductService.createProduct(req), { code } = _a, data = __rest(_a, ["code"]);
            res.status(code).json(data);
        }));
        // get all  product
        this.retrieveProduct = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _b = yield this.ProductService.retrieveProduct(req), { code } = _b, data = __rest(_b, ["code"]);
            res.status(code).json(data);
        }));
        ...
        this.getAllLeadByProduct = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.ProductService.getAllLeadByProduct(req), { code } = _c, data = __rest(_c, ["code"]);
            res.status(code).json(data);
        }));
        // update product
        this.updateProduct = this.asyncWrapper.wrap({
            ...
            const _d = yield this.ProductService.updateProduct(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
        // delete product
        this.deleteProduct = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator("id") }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _e = yield this.ProductService.deleteProduct(req), { code } = _e, data = __rest(_e, ["code"]);
            res.status(code).json(data);
        }));
        ...
        this.retrieveSingleProduct = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator("id") }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _f = yield this.ProductService.retrieveSingleProduct(req), { code } = _f, data = __rest(_f, ["code"]);
            res.status(code).json(data);
        }));
    }
}
exports.default = CRMProductController;
