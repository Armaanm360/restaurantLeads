...
const source_service_1 = __importDefault(require("../service/source.service"));
const source_validation_1 = __importDefault(require("../utils/validation/setting/source.validation"));
class SourceController extends abstract_controller_1.default {
    constructor() {
        super();
        this.SourceService = new source_service_1.default();
