...
class CrmOrganizationService extends abstract_service_1.default {
    constructor() {
        super();
    }
    ...
    createCategoryOrganization(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const newOrg = Object.assign(Object.assign({}, organizationInfo), { organization_id, created_by: id });
    ...
    getAllLeadsByOrganizationName(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { key, from_date, to_date, limit, skip } = req.query;
            const { id } = req.params;
            const { total, data } = yield this.Model.crmSettingModel().getAllLeadsByOrganizationName({
                id: parseInt(id),
                from_date: from_date,
                to_date: to_date,
                limit: limit,
...
exports.default = CrmOrganizationService;
