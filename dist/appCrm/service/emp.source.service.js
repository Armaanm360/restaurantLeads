...
class SourceEmpService extends abstract_service_1.default {
    constructor() {
        super();
    }
    ...
    createSource(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const newSR = Object.assign(Object.assign({}, sourceInfo), { organization_id, created_by_emp_id: id });
                ...
                yield this.Model.crmSettingModel().insertIntosource(newSR);
                return {
                    success: true,
    ...
    retrieveSources(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const { total, data } = yield this.Model.crmSettingModel().retrieveSources(organization_id, {
                    name: name,
                    limit: limit,
                    skip: skip,
                });
    ...
    updateSources(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield model.updateSources({ id, name });
                return {
                    success: true,
                    code: this.StatusCode.HTTP_SUCCESSFUL,
                    message: this.ResMsg.HTTP_SUCCESSFUL,
...
exports.default = SourceEmpService;
