...
exports.airTicketPayloadFormatter = void 0;
...
// INVOICE AIR TICKET
const airTicketPayloadFormatter = (body, conn, invoice_id) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    for (const item of tickets) {
        console.log('Hello World From Ticket Utils', item.airticket_ticket_no, invoice_id);
        ...
        let totalCountryTax = (0, commonTypes_1.numRound)(item.airticket_bd_charge) +
            (0, commonTypes_1.numRound)(item.airticket_ut_charge) +
            (0, commonTypes_1.numRound)(item.airticket_e5_charge);
        const countryTaxAit = totalCountryTax * 0.003;
        const airticket_ait = item.airticket_gross_fare * 0.003 + countryTaxAit;
        const airticket_net_commission = (0, commonTypes_1.numRound)(tkt_commission) - airticket_ait + (taxesCommission || 0);
        const airticket_purchase_price = (0, commonTypes_1.numRound)(item === null || item === void 0 ? void 0 : item.airticket_gross_fare) - (0, commonTypes_1.numRound)(airticket_net_commission);
        const airticket_client_price = (0, commonTypes_1.numRound)(item.airticket_extra_fee) + // Extra fee
            (0, commonTypes_1.numRound)(item === null || item === void 0 ? void 0 : item.airticket_vat) + // VAT
            (item.airticket_gross_fare - (0, commonTypes_1.numRound)(item.airticket_discount_total)); // Gross fare minus discount
        // ----
        invoice_sub_total += (0, commonTypes_1.numRound)(item.airticket_gross_fare);
        invoice_discount += (0, commonTypes_1.numRound)(item === null || item === void 0 ? void 0 : item.airticket_discount_total);
        invoice_service_charge += (0, commonTypes_1.numRound)(item === null || item === void 0 ? void 0 : item.airticket_extra_fee);
        invoice_net_total += airticket_client_price;
        invoice_purchase_total += (0, commonTypes_1.numRound)(airticket_purchase_price);
        const airTicketDetails = {
            ...
            airticket_commission_amount: (0, commonTypes_1.numRound)(tkt_commission),
            airticket_ait,
            ...
            airticket_purchase_price: (0, commonTypes_1.numRound)(airticket_purchase_price),
            airticket_profit: (0, commonTypes_1.numRound)(airticket_net_commission),
    ...
    const invoicePayload = {
        invoice_category_id: commonTypes_2.invCategory['Air Ticket'],
