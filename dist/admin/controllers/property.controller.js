...
class AdminPropertyController extends abstract_controller_1.default {
    ...
    constructor() {
        ...
        //verify property
        this.verifyProperty = this.asyncWrapper.wrap(
        // { arrayBodySchema: this.ActivityValidator.createActivity },
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _e = yield this.service.verifyProperty(req), { code } = _e, data = __rest(_e, ["code"]);
            res.status(code).json(data);
        }));
        ...
        this.getAllPropertyListing = this.asyncWrapper.wrap(
        // { arrayBodySchema: this.ActivityValidator.createActivity },
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _k = yield this.service.getAllPropertyListing(req), { code } = _k, data = __rest(_k, ["code"]);
            res.status(code).json(data);
        }));
    }
}
