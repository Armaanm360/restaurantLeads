...
class AgentLeadService extends abstract_service_1.default {
    constructor() {
        super();
    }
    ...
    getMyLeads(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data, total } = yield model.getLeads(agent_id, req.query);
            return {
                success: true,
                code: this.StatusCode.HTTP_SUCCESSFUL,
                message: this.ResMsg.HTTP_SUCCESSFUL,
    ...
    addTrack(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield model.addTrackingToLead(customTrack);
                return {
                    success: true,
                    code: this.StatusCode.HTTP_SUCCESSFUL,
                    message: this.ResMsg.HTTP_SUCCESSFUL,
    ...
    updateLead(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                //add tracking to the lead manually
                yield model.updateLead(leadId, req.body);
                //auto track
                const customTrack = {
                    inquiry_id: leadId,
                    status: req.body['status'],
...
exports.default = AgentLeadService;
