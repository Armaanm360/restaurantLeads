...
const auth_upc_service_1 = __importDefault(require("../services/auth.upc.service"));
class UpcAuthController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new auth_upc_service_1.default();
        ...
        // change password
        this.changeAdminPassword = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { old_password, new_password } = req.body;
            const { id } = req.upc_user;
            const table = 'upc_user';
...
exports.default = UpcAuthController;
