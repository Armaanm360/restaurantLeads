...
exports.AuthManagementController = void 0;
const abstract_controller_1 = __importDefault(require("../../abstract/abstract.controller"));
const common_service_1 = __importDefault(require("../../common/commonService/common.service"));
const auth_management_service_1 = require("../services/auth.management.service");
class AuthManagementController extends abstract_controller_1.default {
    // private validator = new ServiceCenterValidator();
    constructor() {
        super();
        this.service = new auth_management_service_1.ManagementAuthService();
...
exports.AuthManagementController = AuthManagementController;
