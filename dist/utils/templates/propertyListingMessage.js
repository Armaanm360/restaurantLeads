...
const welcomeMessage = (customerName, propertyAddress) => {
    return `<!DOCTYPE html>
  <html>
    <head>
      <meta charset="UTF-8" />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <title>Welcome to ${templateConstants_1.projectName}</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        <div class="header">
          <h2>Thank You for Listing with ${templateConstants_1.projectName}!</h2>
...
devproperty360@gmail.com`}" class="cta-button">Contact Support</a>
          ...
          <p>Thank you again for choosing ${templateConstants_1.projectName}. We look forward to working together!</p>
        </div>
        <div class="footer">
          &copy; ${new Date().getFullYear()} ${templateConstants_1.projectName}. All rights reserved.
        </div>
      </div>
    </body>
  </html>
