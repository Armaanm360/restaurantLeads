...
exports.newAssociationAccount = void 0;
const templateConstants_1 = require("./templateConstants");
const newAssociationAccount = (email, password, name) => {
    return `<!DOCTYPE html>
  <html>
    <head>
...
Respected dear <strong>${name},</strong><p> 
      ...
      <div style="text-align: left">
                      ...
                      <div
                        ...
                        "
                      >
                        <a href="${templateConstants_1.projectURL}" style="padding-bottom: 16px; text-decoration: none; font-weight: bold;">https://www.m360ict.org<a/>
                      </div>
      <p>Best regards,</p>
      <p>M360ICT</p>
  </div>
...
exports.newAssociationAccount = newAssociationAccount;
